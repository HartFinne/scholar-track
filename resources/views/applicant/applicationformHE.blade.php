...
<body>
    ...
    <div class="ctn-main">
        ...
        <div class="hide">
            ...
            <p class="mt-4 mb-5 description">Welcome to Tzu Chi Scholarship Application Form <strong>(Elementary/High School)</strong>. Please fill out the required fields
