...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/applicantportal.css') }}">
...
<body>
    ...
    <div class="ctn-navbar">
        <div class="logo">
            ...
            <h4>Tzu Chi Philippines<br>Educational Assistance Program</h4>
        </div>
    ...
    <div class="ctn-main">
        <div class="application-info">
            <div class="label">Applicant's Name:</div>
            <div class="value">: <span id="appName">Last Name, First Name Middle Name</span></div>
    
            <div class="label">Application ID</div>
            <div class="value">: <span id="appID">--</span></div>
    
            <div class="label">Application Status</div>
            <div class="value">: <span id="appStatus">--</span></div>    
        </div>
    </div>
    ...
    <div class="appform-view">
        ...
        <div class="page2">
                    ...
                    <tr>
                        <td>
                            ...
                            <span class="svalue" id="natureOfneeds">
                                <input type="radio" name="needs" disabled> Financial<br>
                                <input type="radio" name="needs" disabled> Medical<br>
                                <input type="radio" name="needs" disabled> Food<br>
                                <input type="radio" name="needs" disabled> Material<br>
                                <input type="radio" name="needs" disabled> Education<br>
                                <input type="radio" name="needs" disabled> Others
                            </span>
                        </td>
                        <td style="width: 600px;">
                            <span class="slabel"><strong>Problem Statement</strong></span><br>
                            <span class="svalue" id="probStatement">--</span>
                        </td>                               
                    </tr>
                </table>
            </div>
            <div class="group">
                <div class="groupa">
                    <div class="slabel">Received By:<span id="receivedBy">Last Name, First Name</span></div>
                    <div class="slabel">Date Received:<span id="dateReceived">--</span></div> 
                    <div class="slabel">Assigned District:<span id="assignedDistrict">--</span></div>
                    <div class="slabel">Assigned Volunteer:<span id="assignedVol">--</span></div>
                </div>
                <div class="groupb">
                    ...
                    <div class="groupb1">
                        <div class="group1">
                            <div class="slabel">Case Referred By:<span id="gwa">Last Name, First Name</span></div> 
                            <div class="slabel">Referral Contact no. :<span id="gwa">--</span></div>           
                            <div class="slabel">Relationship with Beneficiary:<span id="conduct">--</span></div>
                        </div>
                        <div class="group2">
                            <div class="slabel">Applicant's Signature:<span id="gwa">--</span></div>           
                            <div class="slabel">Date Reported:<span id="conduct">--</span></div>
                        </div>
                    </div>
                </div>
            </div>
