...
<body>
    ...
    <div class="box-container">
        <div class="box">
            ...
            <div class="content">
                <h5>Who can apply?</h5>
                <p>The scholarship application is open to all <b>incoming 2nd year college ONLY</b> and must be taking
                    up a course that is in the following:</p>
                ...
                <ul>
                    ...
                    <li>Must have a GWA of <span id="crequiredGwa">2.25 (82%)</span> and above with no failing grades in
                        any subject.</li>
                ...
                <ul>
                    ...
                    <li>Scanned copy of Detailed Sketch of Home Address. <span class="sketchinfo">Please draw your exact
                            location
                            legibly and indicate name of landmarks. Eq. name of street, church, sari-sari store,
                            etc.</span></li>
                </ul>

                <h5>Application Process:</h5>
                <ul class="app-process">
                    <li><strong>STEP 01:</strong> Fill out the <a href="{{ route('form-college') }}">Application
                            Form.</a></li>
        ...
        <div class="box">
            <div class="heading">
                <h4>High School Scholarship</h4> <i class="fa-solid fa-chevron-right"></i>
            </div>
            <div class="content">
                <h5>Who can apply?</h5>
                ...
                <ul>
                    <li>Must belong to an INDIGENT or ECONOMICALLY CHALLENGED family.</li>
                    <li>Must have a GWA of <span id="hrequiredGwa">82%</span> and above with no failing grades in any
                        subject.</li>
                    <li>With Good Moral Character.</li>
                    <li>Must be enrolled in partner State University, Colleges, or partner Chinese Schools.</li>
                </ul>
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <ul>
                    <li>Must belong to an INDIGENT or ECONOMICALLY CHALLENGED family.</li>
                    <li>Must have a <span id="erequiredGwa">82%</span> and above with no failing grades in any subject.
                    </li>
                    <li>With Good Moral Character.</li>
                    <li>Must be enrolled in partner State University, Colleges, or partner Chinese Schools.</li>
                </ul>
