        ...
        <div class="container mt-5">
            ...
            <div class="card p-3 bg-light">
                <div class="border bg-success text-white p-3">
                    <h4 class="mb-0"><strong>BOOK ALLOWANCE REQUEST</strong></h4>
                </div>
                <div class="card-body">
                    <form method="POST"
                        action="{{ route('updatespecreq', ['requesttype' => 'BAR', 'id' => $request->id]) }}">
                        @csrf
                        <div class="mb-3 row">
                    ...
                    {{-- REQUEST INFO --}}
                    <div class="row mb-3">
                        <label class="col-sm-4 col-form-label">Title of the Book</label>
                        <div class="col-sm-8">
                            <p class="form-control-plaintext">: {{ $request->booktitle }}</p>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-4 col-form-label">Author</label>
                        <div class="col-sm-8">
                            <p class="form-control-plaintext">: {{ $request->author }}</p>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-4 col-form-label">Book Certification</label>
                        <div class="col-sm-8">:
                            <a href="{{ asset('storage/' . $request->certification) }}" target="_blank"
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-4 col-form-label">Proof of Purchase</label>
                        <div class="col-sm-8">:
                            <a href="{{ asset('storage/' . $request->purchaseproof) }}" target="_blank"
                                rel="noopener noreferrer" class="link-success">Click here to view</a>
                        </div>
                    </div>
                    <div class="row mb-3">
