        ...
        <div class="container mt-5">
            ...
            <div class="card p-3 bg-light">
                <div class="border bg-success text-white p-3">
                    <h4 class="mb-0"><strong>PROJECT ALLOWANCE REQUEST</strong></h4>
                </div>
                <div class="card-body">
                    <form method="POST"
                        action="{{ route('updatespecreq', ['requesttype' => 'PAR', 'id' => $request->id]) }}">
                        @csrf
                        <div class="mb-3 row">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-4 col-form-label">Project Certification</label>
                        <div class="col-sm-8">:
