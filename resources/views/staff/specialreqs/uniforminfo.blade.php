        ...
        <div class="container mt-5">
            ...
            <div class="card p-3 bg-light">
                <div class="border bg-success text-white p-3">
                    <h4 class="mb-0"><strong>UNIFORM ALLOWANCE REQUEST</strong></h4>
                </div>
                <div class="card-body">
                    <form method="POST"
                        action="{{ route('updatespecreq', ['requesttype' => 'UAR', 'id' => $request->id]) }}">
                        @csrf
                        <div class="mb-3 row">
                    ...
                    {{-- REQUEST INFO --}}
                    <div class="row mb-3">
                        <label class="col-sm-4 col-form-label">Uniform Type</label>
                        <div class="col-sm-8">
                            <p class="form-control-plaintext">: {{ $request->uniformtype }}</p>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-4 col-form-label">Certificate of Enrollment or OJT
                            Certificate/Instruction</label>
                        <div class="col-sm-8">:
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-4 col-form-label">Picture of Uniform</label>
                        <div class="col-sm-8">:
