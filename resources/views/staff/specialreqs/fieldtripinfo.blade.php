        ...
        <div class="container mt-5">
            ...
            <div class="card p-3 bg-light">
                <div class="border bg-success text-white p-3">
                    <h4 class="mb-0"><strong>EVENT ALLOWANCE REQUEST</strong></h4>
                </div>
                <div class="card-body">
                    <form method="POST"
                        action="{{ route('updatespecreq', ['requesttype' => 'FTTSAR', 'id' => $request->id]) }}">
                        @csrf
                        <div class="mb-3 row">
                    ...
                    {{-- REQUEST INFO --}}
                    <div class="row mb-3">
                        <label class="col-sm-4 col-form-label">Type of Event</label>
                        <div class="col-sm-8">
                            <p class="form-control-plaintext">: {{ $request->eventtype }}</p>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-4 col-form-label">Event Location</label>
                        <div class="col-sm-8">
                            <p class="form-control-plaintext">: {{ $request->eventloc }}</p>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-4 col-form-label">Official Memo from Subject Professor</label>
                        <div class="col-sm-8">:
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-4 col-form-label">Parent or Guardian Waiver</label>
                        <div class="col-sm-8">:
