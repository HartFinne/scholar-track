        ...
        <div class="container mt-5">
            ...
            <div class="card p-3 bg-light">
                <div class="border bg-success text-white p-3">
                    <h4 class="mb-0"><strong>TRANSPORTATION REIMBURSEMENT REQUEST</strong></h4>
                </div>
                <div class="card-body">
                    <form method="POST"
                        action="{{ route('updatespecreq', ['requesttype' => 'TRF', 'id' => $request->id]) }}">
                        @csrf
                        <div class="mb-3 row">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-4 col-form-label">Purpose/Activity</label>
                        <div class="col-sm-8">
                            <p class="form-control-plaintext">: {{ $request->purpose }}</p>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-4 col-form-label">Name of Assigned Staff/Volunteer</label>
                        <div class="col-sm-8">
                            <p class="form-control-plaintext">: {{ $request->staffname }}</p>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-4 col-form-label">Transportation Reimbursement Form</label>
                        <div class="col-sm-8">:
                            <a href="{{ asset('storage/' . $request->transpoform) }}" target="_blank"
