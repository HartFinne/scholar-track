...
<body>
    ...
    <div class="ctnmain">
        ...
        <div class="groupA">
            <div class="groupA1">
                <div class="groupA2">
                    <span class="subtitle">College Requirements</span>
                    <div class="groupA3">
            ...
            <div class="groupA1">
                <div class="groupA2">
                    <span class="subtitle">Institutions</span>
            ...
            <div class="groupA1">
                <div class="groupA2">
                    ...
                    <form class="groupA3" action="#">
                        <input type="text" id="ininstitute" class="addinput" placeholder="Enter Course" required>
                        <button type="submit" id="btnaddinsti" class="btncontrol">Add</button>
                    </form>
                </div>
                <div class="ctntable table-responsive">
