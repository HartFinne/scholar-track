            ...
            <div class="page1">
                ...
                <div class="personal-info">
                    ...
                    <div class="psec2">
                            ...
                            <table class="table table-bordered" id="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="fvalue" id="occupation">{{ $data['applicant']->occupation }}</span>,<br>
                        ...
                        <img src="{{ asset('storage/' . $data['applicant']->requirements->idpic) }}" alt="Applicant 1x1 Pic">
                    </div>
                </div>
                ...
                <div class="fam-info">
                    ...
                    <div class="table1">
                        <table class="table table-bordered" id="table">
                            <thead>
                                <tr>
                                    <th class="text-center align-center" style="width: 150px;">Name <br><span>(Last Name, First Name)</span></th>
                ...
                <div class="column col-md-5">
                    ...
                    <div class="row my-2 d-flex justify-content-between casedeets">
                        ...
                        <input class="casedeets-input text-center" style="width: 50% !important" type="text"
                            name="datereceived" value="{{ $data['applicant']->casedetails->datereceived ?? '' }}" readonly>
                    </div>
                    <div class="row my-2 d-flex justify-content-between casedeets">
                        Assigned District:
                        <input class="casedeets-input text-center" style="width: 50% !important" type="text"
                    ...
                    <div class="column" style="padding: 0 10px">
                        <div class="row my-2 d-flex justify-content-between casedeets">
                            ...
                            <input class="casedeets-input text-center" style="width: 45% !important" type="text"
                                name="referredby" value="{{ $data['applicant']->casedetails->referredby ?? '' }}" readonly>
                        </div>
                        <div class="row my-2 d-flex justify-content-between casedeets">
                            Referral Contact no.:
