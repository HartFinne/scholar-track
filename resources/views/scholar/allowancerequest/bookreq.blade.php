...
<head>
    ...
    <title>Book Allowance Request</title>
...
<body>
    ...
    <div class="ctn-main">
        ...
        <h2 class="title">Book Allowance Request</h2>
        <div class="instructions">
            <h6>Step 1:</h6>
            <p>Ihanda ang patunay na kinakailangan ang librong bibilhin.
                I-download ang Project/Book Certification Form at ipa-sign sa inyong teacher o professor.</p>

            <h6>Step 2:</h6>
            <p>Ihanda ang resibo at picture ng mga biniling libro. Kung walang resibong ibinibigay ang
            ...
            <h6>Step 4:</h6>
            <p>I-submit ang mga details kasama ang picture at documents sa Book Request Form.</p>
            ...
            <div class="sub-form text-center">
                <a href="{{ route('showrequestform', 'BAR') }}" class="form-btn">Go to submission form</a>
            </div>
        </div>
    </div>
