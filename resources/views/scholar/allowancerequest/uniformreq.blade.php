...
<body>
    ...
    <div class="ctn-main">
        ...
        <div class="instructions">
            ...
            <h6>Step 2:</h6>
            <p>Ihanda ang resibo at picture ng mga biniling uniform. Kung walang resibong ibinibigay ang tindahan o binilhan, 
            ...
            <div class="sub-form text-center">
                <a href="{{ route('uniformform') }}" class="form-btn">Go to submission form</a>
            </div>
        </div>
    </div>
