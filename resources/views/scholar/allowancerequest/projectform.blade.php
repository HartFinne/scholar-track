...
<body>
    ...
    <div class="ctn-main">
        ...
        <div class="form">
            <h2 class="title text-center">Project Request Form</h2>
            <form action="{{ route('reqallowanceproject', $scholar->caseCode) }}" method="post"
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <input type="text" maxlength="255" id="subject" name="subject" required>
                    </div>
                    <div class="form-group">
                ...
                <div class="row">
                    <div class="form-group">
                        <label for="projectCert">Project Certification</label>
                        <input type="file" id="projectCert" name="certification"
