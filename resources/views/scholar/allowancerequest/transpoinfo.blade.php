        ...
        <div class="request-view">
            ...
            <div class="request-info">
                ...
                <div class="info">
                    ...
                    <div class="label">Purpose/Activity:</div>
                    <div class="value"><span>{{ $request->purpose }}</span></div>

                    <div class="label">Name of the Assigned Staff or Volunteer:</div>
                    <div class="value"><span>{{ $request->staffname }}</span></div>

                    <div class="label">Transportation Reimbursement Form:</div>
                    <div class="value">
                        <span>
