...
<body>
    ...
    <div class="ctn-main">
        ...
        <div class="instructions">
            ...
            <h6>Step 4:</h6>
            <p>I-submit ang mga details kasama ang picture at documents sa Field Trip, Training, Seminar Request Form.</p>
            ...
            <div class="sub-form text-center">
                <a href="{{ route ('fieldtripform') }}" class="form-btn">Go to submission form</a>
            </div>
        </div>
    </div>
