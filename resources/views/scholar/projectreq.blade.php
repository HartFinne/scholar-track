...
<head>
    ...
    <title>Project Allowance Request</title>
...
<body>
    ...
    <div class="ctn-main">
        ...
        <h2 class="title">Project Allowance Request</h2>
        <div class="instructions">
            <h6>Step 1:</h6>
            <p>Ihanda ang patunay na kinakailangan ang materials na bibilhin. 
                I-download ang Project/Book Certification Form at ipa-sign sa inyong teacher o professor.</p>

            <h6>Step 2:</h6>
            <p>Ihanda ang resibo at picture ng mga biniling materials. Kung walang resibong ibinibigay ang 
                tindahan o binilhan, ihanda ang Acknowledgement Receipt at papirmahan sa tindahan o sa binilhan.</p>
            ...
            <h6>Step 4:</h6>
            <p>I-submit ang mga details kasama ang picture at documents sa Project Request Form.</p>
            ...
            <div class="file-download">
                <a href="" class="download-btn">Project/Book Certification Form<i class="fas fa-download"></i></a>
            ...
            <div class="sub-form text-center">
                <a href="{{ route('projectform') }}" class="form-btn">Go to submission form</a>
            </div>
        </div>
    </div>
